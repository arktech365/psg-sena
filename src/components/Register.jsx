    ...
    <div className="flex min-h-screen bg-gray-50" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gray-900 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
            Únete a nuestra comunidad y descubre los mejores accesorios de moda.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 lg:px-10">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-gray-500 mb-8">¡Empieza hoy mismo!</p>

          {/* Alerts */}
          {firebaseError && (
            <div className="mb-4 p-3 rounded-lg bg-yellow-50 border border-yellow-200 text-sm text-yellow-700">
              <strong>Configuración incompleta:</strong> {firebaseError}
            </div>
          )}
          {error && (
            <div className="mb-4 flex gap-2 items-start p-3 rounded-lg bg-red-50 border border-red-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input id="email" name="email" type="email" autoComplete="email" required placeholder="mail@ejemplo.com" className={inputCls} value={email} onChange={(e) => setEmail(e.target.value)} disabled={!!firebaseError || loading} />
            </div>
            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Contraseña</label>
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Confirmar contraseña</label>
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="font-medium text-black hover:underline">Iniciar Sesión</Link>
          </p>
