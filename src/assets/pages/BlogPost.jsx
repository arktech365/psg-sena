      ...
      <div className="py-4 bg-white">
        <div className="container px-4 mx-auto">
          <nav className="text-sm">
            <Link to="/home" className="text-black uppercase tracking-widest hover:text-gray-800">Inicio</Link>
            <span className="mx-2 text-gray-400">/</span>
            <Link to="/blog" className="text-black uppercase tracking-widest hover:text-gray-800">Sobre Nosotros</Link>
            <span className="mx-2 text-gray-400">/</span>
      ...
      <div className="container px-4 py-12 mx-auto">
        <div className="flex flex-col gap-8 lg:flex-row">
            ...
            <article className="overflow-hidden bg-white shadow-md rounded-xl">
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-4">
                  <span className="inline-flex items-center px-3 py-1 text-sm font-medium text-gray-800 bg-indigo-100 rounded-full">
                    {post.category}
                  </span>
                ...
                <div className="flex items-center pb-6 mb-8 border-b border-gray-200">
                  <div className="flex items-center justify-center w-10 h-10 mr-3 font-bold text-gray-800 bg-indigo-100 rounded-full">
                ...
                <div className="pt-8 mt-12 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <Link 
                      to="/blog" 
                      className="inline-flex items-center font-medium text-black uppercase tracking-widest hover:text-gray-800"
                    >
                      ← Volver a Sobre Nosotros
                    </Link>
                    <div className="flex space-x-4">
                      <a href="#" className="text-gray-500 hover:text-black uppercase tracking-widest">
          ...
          <div className="lg:w-1/3">
                ...
                {relatedPosts.map(post => (
                  <div key={post.id} className="flex group">
                    ...
                    <div className="ml-4">
                      ...
                      <h4 className="mt-1 font-medium text-gray-900 transition-colors duration-300 group-hover:text-black uppercase tracking-widest">
            ...
            {/* Newsletter */}
            <div className="p-6 text-gray-900 shadow-md bg-gradient-to-r from-indigo-600 to-purple-700 rounded-xl">
